...
import { Copy, ExternalLink, Twitter, TrendingUp, Users, Zap, Rocket } from 'lucide-react';
import './App.css'
...
const OneCoinLanding = () => {
    ...
    return (
        <div className="min-h-screen bg-white overflow-x-hidden">
            ...
            {/* Hero Section */}
            <section id="hero" className={`relative min-h-screen flex items-center justify-center px-4 transition-opacity duration-1000 ${isVisible.hero ? 'opacity-100' : 'opacity-0'}`}>
                {/* Background Pattern */}
                ...
                <div className="relative z-10 text-center max-w-4xl mx-auto">
                    ...
                    <p className="text-sm md:text-lg text-gray-600 mb-8 font-light leading-relaxed"
            ...
            {/* Narrative Section */}
            <section id="narrative" className={`py-30 px-4 bg-gray-50 transition-all duration-1000 transform ${isVisible.narrative ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-5xl md:text-7xl font-black text-black mb-12"
                        style={{ fontFamily: "Caveat, cursive", fontWeight: "bold" }}>Why 1 Coin?</h2>
            ...
            {/* Community Section */}
            <section id="community" className={`py-20 px-4 bg-white transition-all duration-1000 transform ${isVisible.community ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-5xl md:text-7xl font-black text-center text-black mb-12"
                        style={{ fontFamily: "Caveat, cursive", fontWeight: "bold" }}>The 1 Coin Community</h2>
                    ...
                    <div className="flex flex-col gap-1 items-center">
                        <div>
                            <div className="grid grid-cols-2 gap-6">
                                <div className="bg-gradient-to-br from-orange-100 to-orange-200 p-10 rounded-2xl text-center">
                                    ...
                                    <div className="text-3xl font-black text-[#ff9304]" style={{ fontFamily: "Caveat, cursive", fontWeight: "bold" }}>2000+</div>
                                    <div className="text-gray-600 font-medium" style={{ fontFamily: "Inter, san-serif"}}>Members on X</div>
                                </div>
                                ...
                                <div className="bg-gradient-to-br from-blue-100 to-blue-200 p-10 rounded-2xl text-center">
                                    ...
                                    <div className="text-3xl font-black text-blue-600" style={{ fontFamily: "Caveat, cursive", fontWeight: "bold" }}>1 Play</div>
                                    <div className="text-gray-600 font-medium" style={{ fontFamily: "Inter, san-serif"}}>1 Dream</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-3 items-center bg-gray-50 p-8 rounded-2xl">
                            <p className="text-sm text-center leading-relaxed text-gray-700">
                                1 coin, 1 play, 1 sol, 1 dream, 1 right move, <br />1 click can change your life.
                                <span className="font-bold text-[#ff9304]"> This is the 1 on USD1.</span>
                            </p>
            ...
            {/* Token Info Section */}
            <section id="token-info" className={`py-20 px-4 bg-gray-50 transition-all duration-1000 transform ${isVisible['token-info'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-5xl md:text-7xl font-black text-center text-black mb-12"
                        style={{ fontFamily: "Caveat, cursive", fontWeight: "bold" }}>Smart Contract Address</h2>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-lg">
                        ...
                        <p className="text-gray-500 text-sm mt-4 text-center" style={{ fontFamily: "Inter, san-serif"}}>
            ...
            <section id="cta" className={`py-20 px-4  transition-all duration-1000 transform ${isVisible.cta ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
                     style={{
            ...
            {/* Footer */}
            <footer id="footer" className={`bg-black text-white py-12 px-4 transition-all duration-1000 ${isVisible.footer ? 'opacity-100' : 'opacity-0'}`}>
                <div className="max-w-6xl mx-auto">
